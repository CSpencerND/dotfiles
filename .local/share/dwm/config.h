...
const char *spcmd0[] = { "/usr/bin/kitty", "-c", "~/.config/kitty/scratchpad.conf", "--class", "basic",                                   NULL };
const char *spcmd1[] = { "/usr/bin/kitty", "-c", "~/.config/kitty/scratchpad.conf", "--class", "task",    "btop",                         NULL };
const char *spcmd2[] = { "/usr/bin/kitty", "-c", "~/.config/kitty/scratchpad.conf", "--class", "note",    "nvim", "~/Documents/notes/",   NULL };
const char *spcmd3[] = { "/usr/bin/kitty", "-c", "~/.config/kitty/scratchpad.conf", "--class", "explore", "ranger",                       NULL };
...
static Button buttons[] = {
    ...
    /** Touchpad Swipe */
	{ ClkClientWin,         MODKEY,              Button7,        shiftview,      {.i = +1 }  },
	{ ClkClientWin,         MODKEY,              Button6,        shiftview,      {.i = -1 }  },
